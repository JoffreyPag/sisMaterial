...
$id = $_POST['idGuia'];
$tipo = $_POST['tipo'];
$sql = "SELECT g.stats, g.numero_tombo, g.quantidade, g.justificativa, m.especificacao, p.municipio, p.cidade, o.municipio, o.cidade, d.nome, e.nome, e.id_departamento,".(($tipo=="consumo")?"m.id_consumo":"m.id_permanente")."  
        FROM etec_guias g 
    ...
    <form action="../controle/processo_guia.php" method="post">
        ...
        <?php
            if($tipo=="consumo"){
                ...
                //manda parametros pra atualizar o tombo
